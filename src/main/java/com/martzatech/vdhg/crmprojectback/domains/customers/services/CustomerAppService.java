...
import com.martzatech.vdhg.crmprojectback.application.services.mobil.PersonFieldsBlockerAppService;
...
public class CustomerAppService {
  ...
  private PersonFieldsBlockerAppService personFieldsBlockerService;
  ...
  public List<Customer> findAll(final CustomerSpecification specification,final String token, final Pageable pageable) {
